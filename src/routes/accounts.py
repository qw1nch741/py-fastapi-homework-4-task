...
async def register_user(
    ...
    try:
        ...
        background_tasks.add_task(
            ...
            new_user.email,
            f"http://127.0.0.1:8000/api/v1/accounts/activate/?token={activation_token.token}&email={new_user.email}",
        )
...
async def request_password_reset_token(
    ...
    background_tasks.add_task(
        ...
        user.email,
        f"http://127.0.0.1:8000/api/v1/accounts/reset-password/confirm/?token={reset_token.token}",
    )
